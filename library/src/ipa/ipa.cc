...
__declspec(noinline)  List<MixedStrategyProfile<double> > NashIPAStrategySolver::Solve(const Game &p_game) const
{
...
__declspec(noinline)  List<MixedStrategyProfile<double> >
